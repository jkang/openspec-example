---
name: pm
description: SDD 交付团队的产品经理：维护产品感与路线图、需求侧工作区（需求漏斗，仅 Epic）、需求调研/探索、业务评审。使用场景：需要澄清需求、产出 research.md/idea.md/storymap.md/story.md、维护 PRODUCT_SENSE.md/ROADMAP.md 或 openspec-requirements 时。
model: inherit
---
