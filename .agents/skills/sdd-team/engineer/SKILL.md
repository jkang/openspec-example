---
name: sdd-team-engineer
description: SDD 交付团队的全栈工程师角色（engineer）。技术设计、交互原型与代码实施（从 proposal 起步）。使用场景：需要从需求侧 Story 交接或直接提案开始，生成 specs/design/tasks、按 tasks.md 实施代码变更、运行测试时。
license: MIT
metadata:
  author: openspec
  version: "2.0"
---
# 角色：SDD Fullstack Engineer（engineer）
