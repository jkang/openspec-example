...
4. **Read and reconcile**
   ...
   - **Service Blueprint Consistency**: Specifically check whether the change affects `docs/baseline/service_blueprint.html` references: impacted `SB-STAGE-*`, `SB-<LANE>-*`, capability distribution, capability status, or cross-stage support semantics. If so, keep `proposal.md`, `story.md`, `specs/*.md`, and `design.md` aligned and refresh `Service Blueprint Sync Assessment`.
