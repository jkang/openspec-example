...
| stories（Story 交付） | ⬜ 部分 done | 4 个 Story 已产出，待 HITL 确认后交接 |

## Story 交付状态

| Story ID | 状态 | changeName | 开发侧归档 |
| --- | --- | --- | --- |
| story-account-system-register | ready | — | ⬜ |
| story-account-system-login | ready | — | ⬜ |
| story-account-system-session | ready | — | ⬜ |
| story-account-system-admin-users | ready | — | ⬜ |
...
- [ ] **all-done**（全部 Story 开发侧已归档，`epic-account-system.story-list.json` 全 done）
- [ ] **archived**（`epics/account-system/` → `archive/YYYY-MM-DD-account-system/`）
